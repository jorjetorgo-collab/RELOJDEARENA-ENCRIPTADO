...
# 1. Configuración de Precisión y Página (DEBE SER LA PRIMERA LLAMADA A ST)
getcontext().prec = 150
...
class RelojTinta:
    def __init__(self):
        # Lista de versos (Identidad Inicial M0)
        self.M0 = [
        ...
        self.E, self.P = Decimal('2.7182818284'), Decimal('1.61803
